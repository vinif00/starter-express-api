...
# Node 134 + Node 2: normaliza o codigo do material para numero (chave de
# juncao com a tabela de servicos) e mantem apenas os campos usados a jusante
df_fat = (
    df_fat
    ...
    .select(
        ...
        "montante_mi_item", "material", "desc_material",
        "ir", "pis", "cofins", "csll",
    )
)
...
df_servicos = df_servicos_raw.select(
    ...
    "codigo_prefeitura2", "aliquota_iss",
)
...
write_excel(df_regime_especial, PATH_OUT_ZSD_MATERIAL_REG_ESP, rename=RENAME_OUT_REGIME_ESPECIAL)
