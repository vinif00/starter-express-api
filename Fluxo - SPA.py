...
# a tabela de servicos) e mantem apenas os campos usados a jusante. Ao
# contrario do SP, nao existe aqui um filtro "Emite Nota? = SIM": a aba
# "Com NF$" ja vem pre-filtrada na origem.
df_fat = (
    df_fat_raw
